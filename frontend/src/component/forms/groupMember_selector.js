...
export default function GroupMemberSelector({ value, onGroupSelect }) {
...
*/
    ...
    const handleChange = async (event) => {
        ...
        const groupMembers = await getGroup(groupName).members.map(member => `${member.username}#${member.identifier}`);

        onGroupSelect(groupMembers);
    }
